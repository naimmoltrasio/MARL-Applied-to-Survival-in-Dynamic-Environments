...
class CollaborativePickUpEnv(ParallelEnv):
    ...
    def render(self):
        ...
        for i, (x, y, typ) in enumerate(self.objects):
            ...
            color = (0, 0, 255) if typ == "coop" else (255, 165, 0)
            pygame.draw.circle(self.screen, color, center, 20)
            label = font.render("2" if typ == "coop" else "1", True, (255, 255, 255))
        ...
        pygame.draw.rect(self.screen, (255, 0, 0), (*agent1_pos, 40, 40))
        pygame.draw.rect(self.screen, (0, 255, 0), (*agent2_pos, 40, 40))
